...
This forces people to ender valid responses, like you cant put 123456 in an email field because that's not a valid email address.
1. In 1-2 sentences, define end to end testing.
e2e answers the question of "can a user accomplish and action" with a focus on UI.
